...
//Update meal
router.put("/api/meal/:mealId", authController.validateToken, authController.checkIfMealIsFromUser, mealController.validateMealUpdate, mealController.updateMeal);
